...
def calculer_xs(v0, theta, y0, q, m, E):
    """
...
def derivees_partielles(v0, theta, y0, q, m, E):
    """
...
def calculer_incertitude(v0, theta, y0, q, m, E, delta_v0, delta_theta, delta_y0, delta_q, delta_m, delta_E):
    """
